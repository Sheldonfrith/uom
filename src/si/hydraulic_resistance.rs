//!  hydraulic resistance (base unit kg/m⁷).

quantity! {
    /// Hydraulic resistance for  flow (base unit kg/m⁷).
    quantity: HydraulicResistance; " hydraulic resistance";
    /// Dimension of  hydraulic resistance, L⁻⁷M¹ (base unit kg/m⁷).
    dimension: ISQ<
    ...
    units {
        /// Base unit of  hydraulic resistance.
...
mod test {
    storage_types! {
        use crate::num::One;
        use crate::si::hydraulic_resistance as hct;
        ...
        fn check_units() {
            ...
            fn test<M: m::Conversion<V>, L: l::Conversion<V>, HCT: hct::Conversion<V>>() {
                Test::assert_approx_eq(&HydraulicResistance::new::<HCT>(V::one()),
                    &(
                        Mass::new::<M>(V::one()) 
    ...
    fn check_known_conversions() {
        // 1 kg/m⁷ = 1000 g/m⁷
        Test::assert_approx_eq(&HydraulicResistance::new::<hct::kilogram_per_meter_to_the_seventh>(V::one()),
            &HydraulicResistance::new::<hct::gram_per_meter_to_the_seventh>(1000.0));
