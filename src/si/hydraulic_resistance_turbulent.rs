//! Turbulent hydraulic resistance (base unit kg/m⁷).

quantity! {
    /// Hydraulic resistance for turbulent flow (base unit kg/m⁷).
    quantity: HydraulicResistanceTurbulent; "turbulent hydraulic resistance";
    /// Dimension of turbulent hydraulic resistance, L⁻⁷M¹ (base unit kg/m⁷).
    dimension: ISQ<
    ...
    units {
        /// Base unit of turbulent hydraulic resistance.
...
mod test {
    storage_types! {
        use crate::num::One;
        use crate::si::hydraulic_resistance_turbulent as hct;
        ...
        #[test]
        fn check_dimension() {
            let _: HydraulicResistanceTurbulent<V> = (
        ...
        fn check_units() {
            ...
            fn test<M: m::Conversion<V>, L: l::Conversion<V>, HCT: hct::Conversion<V>>() {
                Test::assert_approx_eq(&HydraulicResistanceTurbulent::new::<HCT>(V::one()),
                    &(
                        Mass::new::<M>(V::one()) 
    ...
    fn check_known_conversions() {
        // 1 kg/m⁷ = 1000 g/m⁷
        Test::assert_approx_eq(&HydraulicResistanceTurbulent::new::<hct::kilogram_per_meter_to_the_seventh>(V::one()),
            &HydraulicResistanceTurbulent::new::<hct::gram_per_meter_to_the_seventh>(1000.0));
